# ВНИМАНИЕ: авторизация удалена (DEPRECATED)

Начиная с версии 0.15.0 встроенная авторизация удалена из кода. Этот документ сохранён для истории и не применим к текущей версии сервиса.
